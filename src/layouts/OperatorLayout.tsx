...
import {
  LayoutDashboard, Hash, Users, Truck, FileText,
  Bell, Settings, LogOut, Menu, Leaf
} from "lucide-react";

const NAV_ITEMS = [
  { label: "Operator Dashboard", icon: LayoutDashboard, path: "/operator" },
  { label: "Token Management", icon: Hash, path: "/operator/tokens" },
  { label: "Farmers", icon: Users, path: "/operator/farmers" },
  { label: "Procurement", icon: Truck, path: "/operator/procurement" },
  { label: "Reports", icon: FileText, path: "/operator/reports" },
      ...
      <div className="p-5 border-b border-white/10">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className="text-[10px] text-emerald-300/70 -mt-0.5">Operator Portal</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-3 border-t border-white/10">
        <div className="flex items-center gap-3 px-4 py-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-[10px] text-emerald-300/60">Operator • Karnal Mandi</p>
          </div>
        </div>
